...
const user = useUser();
  ...
  //  viewport={{once:true}}
   ...
   <div className="w-1/4 my-5">
        ...
        <div className='justify-between gap-4 align-middle flex m-4'>
        <input
            type="text"
            ...
            />
            <Link href='adminDash'>
          <Button className='justify-end gap-2' variant='blue'> <Settings />Settings</Button>
            </Link>
            </div>
...
{hoveredMarker && (
      ...
      <Dialog open={Boolean(selectedMarker)} onOpenChange={() => setSelectedMarker(null)}>
        <DialogContent>
          ...
          {/* </DialogHeader> */}
          <div className="flex flex-col gap-4 py-4 justify-center" style={{alignItems:"center"}}>
            ...
            <Image src={selectedMarker?.image} width={100} height={100} alt='img'/>}
          </div>
          <DialogFooter>
